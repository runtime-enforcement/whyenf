...
// sha3: 6ba3d45968c19684c62c38135da154f029dfaa1979760503eabeb2cd05e02520
use crate::ast::*;
...
mod __parse__Log {
    ...
    {
        // Event = Ident, "(", Comma<Val>, ")" => ActionFn(3);
    ...
    {
        // Ident = r#"[A-Za-z_][A-Za-z0-9_]*"# => ActionFn(9);
        let __sym0 = __pop_Variant0(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // Log = TimePointEntry+ => ActionFn(36);
    ...
    {
        // TimePointEntry = "@", Num, ";" => ActionFn(33);
        assert!(__symbols.len() >= 3);
        let __sym2 = __pop_Variant0(__symbols);
    ...
    {
        // TimePointEntry = "@", Num, Event+, ";" => ActionFn(34);
        assert!(__symbols.len() >= 4);
        let __sym3 = __pop_Variant0(__symbols);
    ...
    {
        // TimePointEntry* = TimePointEntry+ => ActionFn(17);
        let __sym0 = __pop_Variant11(__symbols);
        let __start = __sym0.0;
        let __end = __sym0.2;
    ...
    {
        // TimePointEntry+ = TimePointEntry => ActionFn(18);
    ...
    {
        // TimePointEntry+ = TimePointEntry+, TimePointEntry => ActionFn(19);
        assert!(__symbols.len() >= 2);
