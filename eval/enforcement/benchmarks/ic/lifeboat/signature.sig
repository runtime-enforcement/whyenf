...
alert_reboots(data_center_prefix:string, n:int)+
alert_validation_latency(block:string, subnet_id:string, time:int)+
alert_continuous_violations(subnet_id:string, node_id:string, count:int, min:int, max:int)+
