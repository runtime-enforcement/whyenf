...
| "future_reach (And \<phi> \<psi>) = max (future_reach \<phi>) (future_reach \<psi>)"
| "future_reach (Imp \<phi> \<psi>) = max (future_reach \<phi>) (future_reach \<psi>)"
| "future_reach (Iff \<phi> \<psi>) = max (future_reach \<phi>) (future_reach \<psi>)"
| "future_reach (Exists _ \<phi>) = future_reach \<phi>"
| "future_reach (Forall _ \<phi>) = future_reach \<phi>"
| "future_reach (Prev I \<phi>) = future_reach \<phi> - left I"
| "future_reach (Next I \<phi>) = future_reach \<phi> + right I + 1"
| "future_reach (Once I \<phi>) = future_reach \<phi> - left I"
| "future_reach (Historically I \<phi>) = future_reach \<phi> - left I"
| "future_reach (Eventually I \<phi>) = future_reach \<phi> + right I + 1"
| "future_reach (Always I \<phi>) = future_reach \<phi> + right I + 1"
