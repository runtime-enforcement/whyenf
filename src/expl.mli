...
module Pdt : sig
  ...
  val specialize: Lbl.t list -> ('a list -> 'a) -> ('a list -> 'a) -> Valuation.t -> 'a t -> 'a
  val specialize_partial: Lbl.t list -> Valuation.t -> 'a t -> 'a t
  
  val collect: Lbl.t list -> ('a -> bool) -> ((Dom.t, Dom.comparator_witness) Setc.t list -> (Dom.t, Dom.comparator_witness) Setc.t) -> ((Dom.t, Dom.comparator_witness) Setc.t list -> (Dom.t, Dom.comparator_witness) Setc.t) -> Valuation.t -> int -> 'a t -> (Dom.t, Dom.comparator_witness) Setc.t
