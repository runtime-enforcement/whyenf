...
val teval: Lbl.t array -> Valuation.t -> Term.t -> Term.t
val eval_lbl: Lbl.t array -> Valuation.t -> Lbl.t -> Term.t
val eval_lbl_to_lbl: Lbl.t array -> Valuation.t -> Lbl.t -> Lbl.t option
val eval: Lbl.t array -> Valuation.t -> ITerm.t -> ITerm.t
