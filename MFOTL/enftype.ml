...
let tcau       = (Sup.Obs,    Cau.TCau,   Sct.AnySct)
let ncau       = (Sup.Obs,    Cau.Cau,    Sct.NonSct)
let ntcau      = (Sup.Obs,    Cau.TCau,   Sct.NonSct)
let scau       = (Sup.Obs,    Cau.Cau,    Sct.Sct)
let stcau      = (Sup.Obs,    Cau.TCau,   Sct.Sct)
let obs        = (Sup.Obs,    Cau.NonCau, Sct.AnySct)
let sup        = (Sup.Sup,    Cau.NonCau, Sct.AnySct)
let tsup       = (Sup.TSup,   Cau.NonCau, Sct.AnySct)
let nsup       = (Sup.Sup,    Cau.Cau,    Sct.NonSct)
let ntsup      = (Sup.TSup,   Cau.Cau,    Sct.NonSct)
let ssup       = (Sup.Sup,    Cau.Cau,    Sct.Sct)
let stsup      = (Sup.TSup,   Cau.Cau,    Sct.Sct)
let causup     = (Sup.Sup,    Cau.Cau,    Sct.AnySct)
let causuperr  = (Sup.Sup,    Cau.Cau,    Sct.ErrSct)
let caubot     = (Sup.NonObs, Cau.Cau,    Sct.AnySct)
let cauboterr  = (Sup.NonObs, Cau.Cau,    Sct.ErrSct)
let ncaubot    = (Sup.NonObs, Cau.Cau,    Sct.NonSct)
let scaubot    = (Sup.NonObs, Cau.Cau,    Sct.Sct)
let tcaubot    = (Sup.NonObs, Cau.TCau,   Sct.AnySct)
